...
void AdminUI::viewAllUserAccounts()
{
...
void AdminUI::viewProductDetails()
{
...
void AdminUI::EditProductDetails()
{
...
bool AdminUI::motorbikeIdExists(const std::string &motorbikeId)
{
    std::ifstream productFile("ProductDetail.txt");
    std::string line;
...
void AdminUI::DeleteMotorbikeById()
{
